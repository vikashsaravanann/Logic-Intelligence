      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold bg-white border border-gray-200 hover:bg-gray-50 transition-colors text-gray-700 disabled:opacity-50 shadow-sm"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2 py-3 rounded-xl text-sm font-semibold bg-gray-900 border border-transparent hover:bg-gray-800 transition-colors text-white disabled:opacity-50 shadow-sm"
          >
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-sm text-white bg-[#0A0F1E] hover:bg-black transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed mt-2"
          >
            {isLoading ? (
              <>
