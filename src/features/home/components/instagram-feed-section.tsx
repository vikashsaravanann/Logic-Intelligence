        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-2xl mx-auto">
          {instagramPosts.map((post, i) => (
            <motion.a
              ...
              className="group relative aspect-square rounded-2xl border border-white/10 overflow-hidden bg-white/5 shadow-[0_4px_24px_rgba(0,0,0,0.3)] hover:border-pink-500/30 transition-all duration-300"
            >
              {/* Post image */}
              <img
                src={post.image}
